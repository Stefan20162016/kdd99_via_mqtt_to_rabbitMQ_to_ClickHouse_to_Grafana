...
namespace FeatureExtractor {
	...
	public:
		...
		std::string prepare_mqttmessage();
		std::string make_keyval(std::string key, std::string value, int with_value_in_quotes, int is_last);
		//std::string make_keyval(std::string key, std::string value);
